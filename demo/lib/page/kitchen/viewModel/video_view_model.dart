...
class VideoViewModel {
  static Future<VideoModelEntity> getVideoModelData() async {
    ...
    List<VideoModelPortals> portals = modelEntity.portals.map((item) {
    ...
    List<VideoModelContentRecommendations> recommendations = modelEntity.content.recommendations.map((item) {
