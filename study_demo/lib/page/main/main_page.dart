...
import 'package:study_demo/page/bazaar/bazaar_page.dart';
import 'package:study_demo/page/classroom/classroom_page.dart';
import 'package:study_demo/page/collect/collect_page.dart';
import 'package:study_demo/page/kitchen/kitchen_page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    BottomNavigationBarTheme bottomNavigationBarTheme = Provider.of<ThemeChangeNotifier>(context).themeModel.bottomNavigationBarTheme;
    return Scaffold(
      body: PageView(
        children: <Widget>[
          KitchenPage(),
